...
import static quiz.application.Quiz1.answer_g;
import static quiz.application.Quiz1.count;
import static quiz.application.Quiz1.score;
import static quiz.application.Quiz1.timer;
...
public class Quiz2 extends JFrame implements ActionListener {
    ...
    Quiz2(String name)
    {
        ...
        question.setFont(new Font("Tahoma", Font.PLAIN, 26));
        ...
        String[] questionPrompts =
        {
            ...
            "What is thusede return type of the hashCode() method in the Object class?",
        ...
        String[] correctAnswers = {"10", "int", "java.util package", "Marker Interface", "Heap memory",
