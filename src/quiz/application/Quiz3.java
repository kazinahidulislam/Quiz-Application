...
import static quiz.application.Quiz2.answer_g;
import static quiz.application.Quiz2.count;
import static quiz.application.Quiz2.score;
import static quiz.application.Quiz2.timer;
...
public class Quiz3 extends JFrame implements ActionListener {
    ...
    Quiz3(String name)
    {
        ...
        String[][] options =
        {
            {"People's of Bangladesh.", "People's Republic of Bangladesh.", "Bangladesh.", "Republic of Bangladesh."},
        ...
        String[] correctAnswers = {"People's Republic of Bangladesh.", "int", "java.util package", "Marker Interface", "Heap memory",
